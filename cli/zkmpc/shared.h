...
*/
void getAllRandomness(unsigned char key[16], unsigned char randomness[2912], char * challenge) {
...
int verify(a a, int e, z z, char * challenge) {
	...
	getAllRandomness(z.ke, randomness[0],challenge);
	getAllRandomness(z.ke1, randomness[1],challenge);
